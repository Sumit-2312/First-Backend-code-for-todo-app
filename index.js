...
// Import the todo array from storage.js
const todo = require("./Storage");

app.get('/todo', (req, res) => {     
    // jab bho /todo route par get request aayegi, initially jab yeh search hoga too by default hi get request send ho jayegi 
    res.send(todo);
});
